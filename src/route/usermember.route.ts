...
route.get("/usermember/userid/:id", userMemberController.findUserMemberByUserId); // ดู User ด้วย UserId ของ line
...
route.get("/usermember/userid/:id/appid/:appid", userMemberController.findAppId); // ดู App ที่ fav ของ User ด้วย App Id
...
route.put("/usermember/userid/:id/appid/:appid", userMemberController.deleteApp); // ลบ App fav ของ User
